    ...
    <div className="flex">
      ...
      <div className="w-64 bg-gray-800 fixed h-full px-4 py-2">
        <div className="my-2 mb-4">
          <h1 className="text-2x text-white font-bold">Kasir Dashboard</h1>
        </div>
        <hr />
        <ul className="mt-3 text-white font-bold">
          ...
          <li className={`mb-2 rounded hover:shadow py-2 ${isActive('/kasir/menu')}`}>
            <a href="/kasir/menu">
              <MdFoodBank className="inline-block w-6 h-6 mr-2 -mt-2" />
              Menu
            </a>
          </li>
          <li className={`mb-2 rounded hover:shadow py-2 ${isActive('/kasir/meja')}`}>
            <a href="/kasir/meja">
              <MdTableRestaurant className="inline-block w-6 h-6 mr-2 -mt-2" />
              Meja
            </a>
          </li>
          <li className={`mb-2 rounded hover:shadow py-2 ${isActive('/kasir/transaksi')}`}>
